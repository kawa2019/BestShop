...
export default () => {
    const versionsState = [{ version: "Basic", price: "$0", addInfo: "", sizeDisk: "100 MB", subDomain: 1, numEmails: 2, yearsLicense: "Two", modifyClass: "basic" },
    { version: "Professional", price: "$25", addInfo: "Limited offer", sizeDisk: "500 MB", subDomain: 2, numEmails: 5, yearsLicense: "One", modifyClass: "professional" },
